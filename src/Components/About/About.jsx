...
const About = () => {
    return (
        <div>
        <div className="hero min-h-screen mt-14 lg:mt-5">
            <div className="hero-content flex-col lg:flex-row">
                <div className="relative lg:w-1/2">
                    <img src={person} alt="" className="w-3/4 rounded-lg shadow-2xl"/>
                    <img src={parts} alt="" className=" absolute border-8 border-white right-5 top-1/2 w-1/2 rounded-lg shadow-2xl"/>
                </div>
                <div className="lg:w-1/2">
                <h1 className="font-medium text-xl text-[#ff3811]">About Us</h1>
